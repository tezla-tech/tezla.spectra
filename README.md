...
| **[Ictus](plugins/Ictus/)** | **Instrument** — the drum synthesiser for drum and bass, in progress: the kick (a sine body under the two pitch drops the TR-808 analysis separates, parallel odd/even harmonics through ADAA, a pitch-tracking tone, click and noise, a tail) the snare (a three-mode shell at the published ratios under a tension drop, wires that rattle with the shell, the stick's crack), the hats (six band-limited pulses at incommensurate ratios, ring-modulated into a dense wash, overdriven, damped as they decay, with the noise layer rung through the metal's own partials) and the clap (four noise bursts a flam apart, then the room); the rig's rounds since added a 64-mode **Plate** and **Grit** to the hats, then **Under** and **Knock** on the kick, **Ring** and **Thump** on the snares, tilt, attack, grain and an open hold on the hiss, a **Pan**, a **Width** and a **Mono below** per pad on a MIX page with the pads rendering mid and side, a **Room** on four pads, and **five stereo outputs** with an **Output** per pad so the kit splits across mixer tracks; the punch chain, humanise and sample layer to follow | v0.1.0 (kick, snare, ghost snare, hats, clap) — 47/47 on Steinberg's validator; the kick, the hats and the rounds through I4.4 played on the rig, whose ear rounds drove the rest; the fifth round and the outputs not heard there yet |

1241 framework-free DSP tests pass on Linux x86-64, which is where development
