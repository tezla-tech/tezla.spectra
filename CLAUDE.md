...
- **CI has run, and what it proves is narrower than "it works".** Observed on
  ...
  validator 47/47 on Linux. The count has since grown to **1213 on x86-64** (Svarayantra, Ferrite, Malleus, Crossbar, Phonoss, Membrana, Ictus and Stryda included, all fourteen plugins validating 47/47); the
