...
| Kurt James Werner, Jonathan S. Abel, Julius O. Smith, "The TR-808 Cymbal: a Physically-Informed, Circuit-Bendable, Digital Model", ICMC/SMC 2014 | **CC BY 3.0** (stated on the paper). **READ first-hand, user-supplied PDF, 2026-09-02** | The metal generator the hat engine's *808* ratio set is built from — the one table taken under §9's copy-what-measurement-cannot-check rule: **six rectangular oscillators at 205.3, 369.6, 304.4, 522.7 Hz and two tunable ones nominally 800 Hz (359.4–1149.9) and 540 Hz (254.3–627.2), duty 47.98 %**, summed into two band-passes centred ≈3440 Hz and ≈7100 Hz, then envelopes, swing-type VCAs and three Sallen-Key high-passes. Attributed again in `plugins/Ictus/Dsp/HatEngine.hpp`. Also the paper's own practice of rendering at 4× oversampling because the rectangular waves alias — which is why Ictus's pulses are polyBLEP inside the oversampled section rather than naive squares. |
