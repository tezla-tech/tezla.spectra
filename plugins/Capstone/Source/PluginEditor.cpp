...
/// The control this plugin is *about* -- the threshold is what a limiter is set by.
///
...
{
    return id == ids::threshold ? ui::design::Emphasis::lead
