...
/// The control this plugin is *about* -- Decay is what makes a struck body a
/// gong or a block, and it is what a player reaches for first.
///
...
{
    return id == ids::decay ? ui::design::Emphasis::lead
