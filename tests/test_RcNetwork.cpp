...
#include <tezla/dsp/RcNetwork.hpp>

using namespace tezla::dsp;

namespace
{
using Network = RcNetwork<>;
...
TEZLA_TEST (rc_network_solves_a_resistive_divider_exactly)
{
...
TEZLA_TEST (rc_network_lowpass_corner_is_where_circuit_theory_puts_it)
{
...
TEZLA_TEST (rc_network_highpass_is_the_mirror_of_it)
{
...
TEZLA_TEST (rc_network_loads_itself_the_way_a_real_one_does)
{
...
TEZLA_TEST (rc_network_warps_towards_nyquist_like_every_bilinear_filter)
{
...
TEZLA_TEST (rc_network_is_the_same_circuit_at_every_sample_rate)
{
...
TEZLA_TEST (rc_network_is_silent_in_silence_and_stable_when_shorted)
{
    Network network;
...
TEZLA_TEST (rc_network_survives_a_floating_node)
{
